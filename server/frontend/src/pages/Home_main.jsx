  ...
  const handleShowMore = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('Failed to fetch more events');
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen">
      <div className="h-80 sm:h-96 xl:h-[500px] 2xl:h-[600px] p-0.5">
        <Carousel>
        {/* <img src="/1.jpg" alt="Image 1" className="object-cover" /> */}
      <img src="/2.jpg" alt="Image 2" className="object-cover" />
      {/* <img src="/3.jpg" alt="Image 3" className="object-cover" /> */}
      <img src="/4.jpg" alt="Image 3" className="object-cover" />
      <img src="/5.jpg" alt="Image 3" className="object-cover" />
        </Carousel>
      </div>
